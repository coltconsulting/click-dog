...
the optional [bootstrap verification](https://click-dog.com/install/#optional-authenticate-installsh-before-sudo).
...
The [Install Guide](https://click-dog.com/install/) covers Ansible, Kubernetes,
