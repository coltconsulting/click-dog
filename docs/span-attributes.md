...
| Field | Description |
|---|---|
| `trace_id` | Generated by the OTEL SDK (new for each query) |
| `span_id` | Generated by the OTEL SDK |
...
All default to 100,000 characters after config loading. Set `monitor.max_query_length: 0` to disable the fetch-time length limit and live `query_log.normalized_query` truncation. Set `exporters.otel[].max_query_length: 0` or `exporters.splunk_hec[].max_query_length: 0` to disable export-time truncation for those exporters.
