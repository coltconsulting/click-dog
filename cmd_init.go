...
// isTTY reports whether stdin is a real interactive terminal. It asks the
// terminal driver rather than testing os.ModeCharDevice, which /dev/null —
// what systemd and cron hand a process — also satisfies.
func isTTY() bool {
